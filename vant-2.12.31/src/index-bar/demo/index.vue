<template>
  <demo-section>
    <van-tabs v-model="activeTab" swipe-threshold="3">
      ...
      <van-tab title="微信通讯录">
        <van-index-bar :index-list="contactsIndexs" :ignoreTags="['@']" hint-type="left" highlight-background-color="#07C160" highlight-color="#fff">
          <div>
      ...
      <van-tab title="微信通讯录(插槽)">
        <van-index-bar hint-type="left" :index-list="contactsIndexs" :ignoreTags="['@']" highlight-background-color="#07C160" highlight-color="#fff">
          <!-- tag 插槽 -->
          <template #tag="props">
